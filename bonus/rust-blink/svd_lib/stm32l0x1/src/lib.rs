#![doc = "Peripheral access API for STM32L0X1 microcontrollers (generated using svd2rust v0.22.2 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl SYSCFG_COMP {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const syscfg_comp::RegisterBlock = 0x4001_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl core::fmt::Debug for SYSCFG_COMP {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSCFG_COMP").finish()
    }
}
#[doc = "System configuration controller and COMP register"]
pub mod syscfg_comp;
