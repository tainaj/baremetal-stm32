...
#[doc = "Field `CRYPTSMEN` reader - Crypto clock enable during sleep mode bit"]
pub struct CRYPTSMEN_R(crate::FieldReader<bool, bool>);
impl CRYPTSMEN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CRYPTSMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CRYPTSMEN_R {
...
#[doc = "Field `CRYPTSMEN` writer - Crypto clock enable during sleep mode bit"]
...
impl R {
    ...
    pub fn cryptsmen(&self) -> CRYPTSMEN_R {
        CRYPTSMEN_R::new(((self.bits >> 24) & 1) != 0)
    }
